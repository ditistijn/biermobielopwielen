/**
  @file    BiermobielOpWielen_esp8266_AP.ino
  @brief   Example of commands to control the car :
           ...
           ACTION:
           - http://<YourIP>:<YourPort>/action?type=1 (Honk)
           - http://<YourIP>:<YourPort>/action?type=1 (Action 2)


  @author  Tijn Coertjens
  @date    12-2021
*/
...
const char *ssid = "BierMobielOpWielen";
const char *password = "jemoeder69";
